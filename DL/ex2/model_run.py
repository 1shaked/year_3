        ...
        for learning_rate in learning_rates:
            for hidden_size in hidden_sizes:
                ...
                for epochs in epochs_sizes:
                    ...
                    total_loss += losses
                    print(f'-----------------------------')
                print(f'the accuracy is {acc} And the loss is {total_loss}')
                print(f"batch_size: {batch_size}, learning_rate: {learning_rate}, hidden_size: {hidden_size}")
                save_model(W1, b1, W2, b2,batch_size, learning_rate, epochs ,f'model_{batch_size}_{learning_rate}_{hidden_size}_{epochs}.json')
